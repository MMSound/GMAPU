...
function musTest2()
{
	var _arr = [];
	var i = 0;
	_arr[i++] = [[15, __], [nG_4, __PULSE,_, 1.00, [0, 1000], 0], [nAs3, __PULSE,_, 0.40, __, -1  ], [nG_3, __PULSE,_, 0.40, __, 0],	[nD_3, __PULSE,_, 0.40, __, 0]	];
	...
	_arr[i++] = [[__, __], [nFs4, __     ,_, __  , [0, 500] , 0], [nA_3, __     ,_, 0.40, __, 0   ], [nFs3, __     ,_, 0.40, __, 0],	[nC_3, __     ,_, 0.40, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nD_4, __     ,_, __  , [0, 1000], 0], [n___, __     ,_, 0.25, __, 0   ], [n___, __     ,_, 0.25, __, 0],	[n___, __     ,_, 0.25, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nF_4, __     ,_, __  , [0, 1000], 0], [nGs3, __     ,_, 0.40, __, 0   ], [nF_3, __     ,_, 0.40, __, 0],	[nB_2, __     ,_, 0.40, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nG_4, __     ,_, __  , __       , 0], [n___, __     ,_, 0.25, __, 0   ], [n___, __     ,_, 0.25, __, 0],	[n___, __     ,_, 0.25, __, 0]	];
	_arr[i++] = [[__, __], [nF_4, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nE_4, __     ,_, __  , [0, 650] , 0], [nG_3, __     ,_, 0.40, __, 0   ], [nE_3, __     ,_, 0.40, __, 0],	[nAs2, __     ,_, 0.40, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nC_4, __     ,_, __  , __       , 0], [n___, __     ,_, 0.25, __, 0   ], [n___, __     ,_, 0.25, __, 0],	[n___, __     ,_, 0.25, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , [0, 100] , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nDs4, __     ,_, __  , __       , 0], [nFs3, __     ,_, 0.40, __, 0   ], [nDs3, __     ,_, 0.40, __, 0],	[nA_2, __     ,_, 0.40, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nD_4, __     ,_, __  , __       , 0], [n___, __     ,_, 0.25, __, 0   ], [n___, __     ,_, 0.25, __, 0],	[n___, __     ,_, 0.25, __, 0]	];
	_arr[i++] = [[__, __], [nC_4, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nD_4, __     ,_, __  , __       , 0], [nF_3, __     ,_, 0.40, __, 0   ], [nD_3, __     ,_, 0.40, __, 0],	[nGs2, __     ,_, 0.40, __, 0]	];
	_arr[i++] = [[__, __], [nC_4, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [nAs3, __     ,_, __  , __       , 0], [n___, __     ,_, 0.25, __, 0   ], [n___, __     ,_, 0.25, __, 0],	[n___, __     ,_, 0.25, __, 0]	];
	_arr[i++] = [[__, __], [nA_3, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[6 , __], [nFs3, __     ,_, 0   , [1 , 100], 0], [nD_3, __     ,_, 0.40, __, 0   ], [nA_2, __     ,_, 0.40, __, 0],	[nFs2, __     ,_, 0.40, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[7 , __], [nC_4, __     ,_, 0   , [1 , 100], 0], [n___, __     ,_, 0.25, __, 0   ], [n___, __     ,_, 0.25, __, 0],	[n___, __     ,_, 0.25, __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[8 , __], [nAs3, __     ,_, 0   , [1 , 100], 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[__, __], [n___, __     ,_, __  , __       , 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
	_arr[i++] = [[9 , __], [nA_3, __     ,_, 0   , [1 , 100], 0], [n___, __     ,_, __  , __, 0   ], [n___, __     ,_, __  , __, 0],	[n___, __     ,_, __  , __, 0]	];
